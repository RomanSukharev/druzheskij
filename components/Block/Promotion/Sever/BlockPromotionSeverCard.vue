...
export interface IBlockPromotionSeverCardProps {
...
var props = defineProps<IBlockPromotionSeverCardProps>()
...
<template>
  <article class="BlockPromotionSeverCard" :id="`plan_${plan.article}`">
    <div class="BlockPromotionSeverCard__topContent">
      <button class="SeverPlanCard__btnSeeVideo" v-if="plan.video_review" @click="openVideo(plan.video_review)">
    ...
    <div class="BlockPromotionSeverCard__bottomContent">
      <div class="BlockPromotionSeverCard__bottomContentTop">
        ...
        <PartPlanCardPrograms :cost="+plan.cost" :programs="plan.programs" />
      </div>
